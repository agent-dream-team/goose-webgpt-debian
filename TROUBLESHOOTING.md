...
> **HERITAGE DOCUMENT:** The setup/repair steps below target the inherited Codex product. Do not use browser smoke, Install models, Repair Codex setup, or Codex restart as Goose rebuild recovery. Use `AGENTS.md` and `docs/persistent-chat-rebuild-plan.md`.
