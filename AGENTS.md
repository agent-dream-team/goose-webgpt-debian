...
This checkout contains the qualified Goose ChatGPT Web V1. Read `docs/persistent-chat-lifecycle.md` before architecture, browser, lifecycle, or recovery work; it owns the non-negotiable persistent-conversation invariants. Then read `docs/persistent-chat-follow-up.md` for the current implementation/qualification gaps. The qualified installed runtime behavior is based on source checkpoint `c74493b32759014a27611f14bbc4e74d688e7d06` (`Make broker ownership robust to PID reuse`), immutable bundle `dc133c72e88d8802cb5abc892e974f2cbcb83b2ad3196111ac6e07a7ca0f3a3e`, AppImage SHA-256 `7472332120a62769a935f0c3268361691b48384d823cbd106e76e7ef72eb42ce`. Repository HEAD may be newer, but source after that checkpoint is not installed authority until separately packaged and qualified.
