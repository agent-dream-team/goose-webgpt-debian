...
> **HERITAGE DOCUMENT:** This describes the inherited Codex-oriented architecture. It remains useful for mechanisms we may adapt, but it is **not the current Goose rebuild architecture or setup authority**. See `AGENTS.md` and `docs/persistent-chat-rebuild-plan.md`.
