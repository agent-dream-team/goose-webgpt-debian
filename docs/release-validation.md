...
> **HERITAGE DOCUMENT:** These release checks target the inherited Codex product. They are not the Gate K acceptance sequence for the persistent Goose rebuild unless a specific check is explicitly reused by the rebuild plan.
